...
this["JST"]["intro"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  return "\n<h1>Hi! I'm Spen Taylor</h1>\n\n<p>Here you can find out more <a href=\"#/about\" class=\"about\">about</a> me,<br> read my <a href=\"#/blog\" class=\"blog\">blog posts</a> or<br> check out some of my <a href=\"#/projects\" class=\"projects\">projects</a>.<br> Oh and feel free to <a href=\"#/contact\" class=\"contact\">get in touch!</a>\n</p>\n<p style=\"font-size: .85em;\">{ I'm still working on this site, so please bare with me! ^_^ }</p>";
  },"useData":true});
