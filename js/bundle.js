...
module.exports = CollectionExtension.extend({
  ...
  stubs: stubs,
	...
	isLoading: false,
  url: function(){
  	return 'http://public-api.wordpresccwes.com/rest/v1.1/sites/ijustwanttotesttheapi.wordpress.com/posts?callback=?';
  },
